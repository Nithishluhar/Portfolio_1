...
const Testimonials = () => {
  const testimonials = [
    {
      id: 1,
      link: 'https://www.guvi.in/verify-certificate?id=2i7h8Ie6020W81R972',
      name: 'Guvi, IITM- Chennai ( 2023 )',
      role: 'Full-Stack Web Developer - MERN. JavaScript | ExpressJS | React | Redux | NodeJS | MongoDB | AWS | ',
    ...
    {
      id: 2,
      link: 'https://www.linkedin.com/in/nithish06/',
      name: 'Bachelor"s Degree in Electronics and Communication Engineering',
      role: 'Sri Sairam Engineering College, Chennai ( 2018 - 2022 ) ',
    ...
    },
    {
      ...
      role: 'PSG Polytechnic college, Coimbatore ( 2016 - 2018 ) ',
    ...
    },
    {
      id: 4,
      link: 'https://www.linkedin.com/in/nithish06/',
      name: 'HSC-12th- Mathematics & Biology',
      role: 'Sri Ragavendra Matric School, Salem ( 2013 - 2014 )',
    ...
    },
    {
      ...
      link: 'https://www.linkedin.com/in/nithish06/',
      name: 'SSLC- 10th  ',
      role: 'Auxlium Matric School, Cuddalore ( 2013 - 2014 ) ',
    ...
    <section id="testmonials">
      ...
      <Swiper 
        ...
        {testimonials.map((test) => (
          ...
          <small className="client__review">{test.role}</small>
        </SwiperSlide>
        ))}
      </Swiper>
    </section>
